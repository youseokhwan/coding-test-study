...
for _ in range(0, n):
    ...
    if _point_arr[1] in _input_dict:
        _input_dict[_point_arr[1]].append(_point_arr[0])
    # 없으면 새로운 리스트로 저장
    else:
        _input_dict[_point_arr[1]] = [_point_arr[0]]
        # 키 리스트에도 저장
        _key_list.append(_point_arr[1])
